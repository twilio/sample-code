...
class Program 
{
    static void Main(string[] args)
    {
        ...
        var authCallsIpAccessControlListMapping = AuthCallsIpAccessControlListMappingResource.Fetch(
            pathDomainSid: "SDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            pathSid: "ALXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        );

        Console.WriteLine(authCallsIpAccessControlListMapping.FriendlyName);
    }
}
