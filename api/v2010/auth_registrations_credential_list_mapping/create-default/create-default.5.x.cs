...
class Program 
{
    static void Main(string[] args)
    {
        ...
        var authRegistrationsCredentialListMapping = AuthRegistrationsCredentialListMappingResource.Create(
            credentialListSid: "CLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            pathDomainSid: "SDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        );

        Console.WriteLine(authRegistrationsCredentialListMapping.Sid);
    }
}
