...
class Program 
{
    static void Main(string[] args)
    {
        ...
        var authRegistrationsCredentialListMapping = AuthRegistrationsCredentialListMappingResource.Fetch(
            pathDomainSid: "SDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
            pathSid: "CLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
        );

        Console.WriteLine(authRegistrationsCredentialListMapping.FriendlyName);
    }
}
