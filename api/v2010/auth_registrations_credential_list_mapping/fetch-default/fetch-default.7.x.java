...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        AuthRegistrationsCredentialListMapping authRegistrationsCredentialListMapping = 
            AuthRegistrationsCredentialListMapping.fetcher(
                "SDXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",
                "CLXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")
            .fetch();

        System.out.println(authRegistrationsCredentialListMapping.getFriendlyName());
    }
}